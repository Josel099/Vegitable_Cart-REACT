...
const Navbar = () => {
  ...
  <Button  colorScheme='green'  borderLeftRadius={"none"}  borderColor={"#80ff80"} borderWidth={"thin"} color='white' borderLeftWidth={"0px"}>
  ...
  <Flex marginLeft='50px'>
    ...
    <Flex  flexDirection={"column"} align="end">
        <Text fontWeight={'bold'} color={"##006442"} >No.of items : 0</Text>
        <Text  fontWeight={'bold'} color={"#006442"}>Sub Total   : 0</Text>
    </Flex>
    <Button  marginLeft='25px' colorScheme={'green'}> <BsCart4 size={"25px"}/> </Button>
  </Flex>
  <Flex >
 <Button marginLeft='25px' colorScheme={'green'} color={'white'} marginBottom={"2.5"} >
